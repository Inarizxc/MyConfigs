...
#s(hash-table test equal data ("straight" ("2025-10-06 02:49:48" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "main" :package "straight" :local-repo "straight.el")) "org-elpa" ("2025-10-06 02:49:48" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2025-10-06 02:49:59" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2025-10-06 02:50:00" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "use-package" ("2025-10-06 02:50:04" ("emacs" "bind-key") (:type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git")) :package "use-package" :local-repo "use-package")) "bind-key" ("2025-10-06 02:50:03" ("emacs") (:type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git")) :package "bind-key" :local-repo "bind-key")) "micromamba" ("2025-10-06 02:58:48" ("emacs" "pythonic") (:type git :host github :repo "SqrtMinusOne/micromamba.el" :package "micromamba" :local-repo "micromamba.el")) "pythonic" ("2025-10-06 02:58:48" ("emacs" "s" "f") (:type git :host github :repo "pythonic-emacs/pythonic" :package "pythonic" :local-repo "pythonic")) "s" ("2025-10-06 02:58:43" nil (:type git :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "f" ("2025-10-06 02:58:48" ("emacs" "s" "dash") (:type git :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el")) "dash" ("2025-10-06 02:58:47" ("emacs") (:type git :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "no-littering" ("2025-10-06 02:58:53" ("emacs" "compat") (:type git :host github :repo "emacscollective/no-littering" :package "no-littering" :local-repo "no-littering")) "compat" ("2025-10-06 02:58:53" ("emacs" "seq") (:type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git")) :package "compat" :local-repo "compat")) "seq" ("2025-10-06 02:58:52" nil (:type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git")) :package "seq" :local-repo "seq"))))
...
(fn &rest ARGS)" nil t) (autoload 'describe-personal-keybindings "bind-key" "Display all the personal keybindings defined by `bind-key'." t) (register-definition-prefixes "bind-key" '("bind-key" "override-global-m")) (provide 'bind-key-autoloads)) "use-package" ((use-package-autoloads use-package-jump use-package-diminish use-package-ensure-system-package use-package-bind-key use-package use-package-ensure use-package-lint use-package-core use-package-delight use-package-pkg) (autoload 'use-package-autoload-keymap "use-package-bind-key" "Load PACKAGE and bind key sequence invoking this function to KEYMAP-SYMBOL.
...
(fn VIRTUALENV)" t) (autoload 'pythonic-deactivate "pythonic" "Deactivate python virtual environment." t) (register-definition-prefixes "pythonic" '("pythonic-")) (provide 'pythonic-autoloads)) "micromamba" ((micromamba micromamba-autoloads) (autoload 'micromamba-activate "micromamba" "Switch to environment with PREFIX (path).  Prompt if called interactively.

If some environments have duplicate names, these names are replaced by
full paths.

(fn PREFIX)" t) (autoload 'micromamba-deactivate "micromamba" "Deactivate the current environment." t) (autoload 'micromamba-env-activate-for-buffer "micromamba" "Activate the conda environment implied by the current buffer.
...
`environment.yml` or similar at the project level." t) (defvar micromamba-env-autoactivate-mode nil "Non-nil if Micromamba-Env-Autoactivate mode is enabled.
See the `micromamba-env-autoactivate-mode' command
for a description of this minor mode.
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `micromamba-env-autoactivate-mode'.") (custom-autoload 'micromamba-env-autoactivate-mode "micromamba" nil) (autoload 'micromamba-env-autoactivate-mode "micromamba" "Toggle conda-env-autoactivate mode.
...
(fn &optional ARG)" t) (register-definition-prefixes "micromamba" '("micromamba-")) (provide 'micromamba-autoloads)) "seq" ((seq-autoloads seq-pkg seq-24 seq-25 seq) (register-definition-prefixes "seq-24" '("seq")) (autoload 'seq-subseq "seq-25" "Return the sequence of elements of SEQUENCE from START to END.
END is exclusive.
...
you must turn of these features completely.") (register-definition-prefixes "no-littering" '("emacs-session-filename" "no-littering-")) (provide 'no-littering-autoloads))))

#s(hash-table test eq data (org-elpa #s(hash-table test equal data (version (16 "https://github.com/emacs-straight/org-mode.git") "use-package" nil "bind-key" nil "micromamba" nil "pythonic" nil "s" nil "f" nil "dash" nil "no-littering" nil "compat" nil "seq" nil)) melpa #s(hash-table test equal data (version 3 "use-package" nil "bind-key" nil "micromamba" (micromamba :type git :host github :repo "SqrtMinusOne/micromamba.el") "pythonic" (pythonic :type git :host github :repo "pythonic-emacs/pythonic") "s" (s :type git :host github :repo "magnars/s.el") "f" (f :type git :host github :repo "rejeep/f.el") "dash" (dash :type git :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "no-littering" (no-littering :type git :host github :repo "emacscollective/no-littering") "compat" nil "seq" nil)) gnu-elpa-mirror #s(hash-table test equal data (version 3 "use-package" (use-package :type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git"))) "bind-key" (bind-key :type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git"))) "compat" (compat :type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git"))) "seq" (seq :type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git")))))))

("seq" "compat" "no-littering" "dash" "f" "s" "pythonic" "micromamba" "bind-key" "use-package" "emacsmirror-mirror" "el-get" "nongnu-elpa" "gnu-elpa-mirror" "melpa" "org-elpa" "emacs" "straight")
