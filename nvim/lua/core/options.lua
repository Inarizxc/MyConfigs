vim.wo.number = true -- Цыфры
vim.wo.relativenumber = true -- Цыфре относительно выбранной строки
vim.o.clipboard = "unnamedplus" -- Синхронизация буфера обмена с системой
vim.o.wrap = false -- Не разделять слишком длинные строки
vim.o.linebreak = true -- Не разделять слова
